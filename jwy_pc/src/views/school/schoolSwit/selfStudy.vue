<template>
  <div class="vessel">
    ...
    <div class="row">
      <div class="zx_left">
        <div class="title">聚焦<span class="color">自学考试</span><span class="subhead">JUJIAOZIXUEKAOSHI</span></div>
        <div class="conter">
...
export default {
  ...
  data () {
    return {
      ...
      switcher: 'news',
      srcs: [
        require('@/assets/school/about_img1.jpg'),
